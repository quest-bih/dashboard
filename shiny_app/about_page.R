...
')),
                       ...
                       helpText(HTML('<a href="https://www.bihealth.org/de/translation/innovationstreiber/quest-center/teams/team-quest-services" title="Contact person for ODDPub">Nico Riedel</a> (Conceptualization, Methodology, Technical Implementation, Validation);
                       ...
                       helpText(HTML('Nico Riedel (Conceptualization, Methodology, Technical Implementation);
                                <a href="https://www.bihealth.org/en/translation/innovation-enabler/quest-center/teams/research-group-weissgerber" title="Contact person for Barzooka metrics">Tracey Weissgerber</a> (Conceptualization, Methodology); Robert Schulz (Validation); Vladislav Nachev (Technical Impelementation)')),
                       br(),
                       ...
                       helpText(HTML('Nico Riedel (Conceptualization, Methodology, Technical Implementation);
                                ...
                                <a href="https://www.bihealth.org/en/translation/innovation-enabler/quest-center/teams/rg-strech" title="Contact person for Clinical trial metrics">Maia Salholz-Hillel</a> (Conceptualization, Methodology), Benjamin Gregory Carlisle (Conceptualization, Methodology); Vladislav Nachev (Methodology, Technical Impelementation)')),
                       br(),
                       ...
                       helpText(HTML('<a href="https://www.bihealth.org/de/translation/innovationstreiber/quest-center/teams/team-quest-services" title="Contact person for Shiny app">Nico Riedel</a> (Conceptualization, Technical Implementation); Tracey Weissgerber (Conceptualization);
                                ...
                                Delwen Franzen (Conceptualization); Maia Salholz-Hillel (Conceptualization); Jan Taubitz (Conceptualization, Technical Implementation); Vladislav Nachev (Technical Impelementation)')),
                       br(),
                       h3('Acknowledgment'),
