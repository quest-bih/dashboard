...
')),
                       ...
                       helpText(HTML('Nico Riedel (Conceptualization, Methodology, Technical Implementation); Tracey Weissgerber (Conceptualization, Methodology); Robert Schulz (Validation)')),
                       br(),
                       ...
                       helpText(HTML('Nico Riedel (Conceptualization, Methodology, Technical Implementation);
                                ...
                                Peter Grabitz (Conceptualization, Methodology); Delwen Franzen (Conceptualization, Methodology);Maia Salholz-Hillel (Conceptualization, Methodology), Benjamin Gregory Carlisle (Conceptualization, Methodology)')),
                       br(),
