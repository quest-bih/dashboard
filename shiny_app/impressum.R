...
impressum_text <- HTML('<b>Information according to <a href="https://www.gesetze-im-internet.de/tkg_2021/__5.html">§ 5 TKG</a></b><p></p>
		...
		Web: <a href="https://quest.bihealth.org/">quest.bihealth.org</a><br>
		Email: quest@bih-charite.de
		</p>

		</p><p><b>Regulatory Authority</b>:</p>

		<p><a href="https://www.datenschutz-berlin.de/">Berliner Beauftragte für Datenschutz und Informationßicherheit</a> (Berlin Commissioner for Data Protection and Information Security)</p>
...
content. As a service provider, we are responsible
		for our own content on these pages under the general laws according to
 § 7 para. 1 TMG. According to §§ 8 to 10 TMG, however, we are not
obligated as a service provider to monitor transmitted
...
information under the general laws remain unaffected.
...
become aware of such infringements, we will remove
...
liability for these external contents. The respective
		provider or operator of the pages is always responsible for the
content of the linked pages. The linked pages were checked for possible
legal violations at the time of linking. Illegal
...
without concrete evidence of a violation of the law.
		If we become aware of any infringements, we will remove such links
immediately.
		</p>
 ...
 or any form of commercialization of such material
		beyond the scope of the copyright law shall require the prior written
consent of its respective author or creator. Downloads and copies of
this site are only permitted for private,
...
personal data. Insofar as personal data (for example, name, address or
e-mail addresses) are collected on our pages, this is
		always done, as far as possible, on a voluntary basis. This data will
...
obligation by third parties for the purpose of sending unsolicited
advertising and information materials is hereby
...
advertising information, such as spam e-mails.
		...
		<p><br>Imprint by <a href="https://www.impressum-generator.de/">Impressum Generator</a> of the
		<a href="https://www.kanzlei-hasselbach.de/standorte/frankfurt/" rel="nofollow">Kanzlei Hasselbach, Frankfurt</a>.<br><br></p>')

datenschutz_text <- HTML('<h1>Datenschutz&shy;erkl&auml;rung</h1>
...
wenden.</p>
<h2>2. Hosting</h2>
<p>Wir hosten die Inhalte unserer Website auf Server der Charité – Universitätsmedizin Berlin.
...
dieser Website ist:</p> <p>Berlin Datenschutzbehörde<br />
Friedrichstraße 219,<br />
10969 Berlin</p>
<p>Telefon: +49 (0) 030/138 89-0<br />
